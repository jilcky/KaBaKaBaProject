...
lineheight=string_height("XgpT")*uiYscale  + uiLineSpacing;
     ...
     if (cury)<(visible_ytop-maxLineHeight)   //if not visible then draw at alpha 0 at postion 0....
              { cury+=th
               ...
               {          
                ...
                draw_text_transformed(px+uiLeftMargin,sur_pos+2,disptx,uiXscale,uiYscale,0);     
...
if uiTextLabel !="" draw_text_transformed(px,y-th+2,uiTextLabel,uiXscale,uiYscale,0);  
