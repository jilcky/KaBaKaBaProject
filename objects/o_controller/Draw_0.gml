...
// texture
draw_sprite_pos_fixed_scripts(s_texture, 0, 100+xx[0], 208+yy[0], 356+xx[1], 208+yy[1], 356+xx[2], 464+yy[2], 100+xx[3], 464+yy[3], c_white, 1);
draw_sprite_pos(s_texture, 0, 456+xx[0], 208+yy[0], 712+xx[1], 208+yy[1], 712+xx[2], 464+yy[2], 456+xx[3], 464+yy[3], 1);

// sprite
draw_sprite_pos_fixed_scripts(s_sprite, 0, 812+xx[0], 240+yy[0], 932+xx[1], 240+yy[1], 932+xx[2], 431+yy[2], 812+xx[3], 431+yy[3], c_white, 1);
...
draw_sprite(s_sprite,0,100+128+xx[3],464+yy[3]-128)