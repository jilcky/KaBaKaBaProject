...
// 	var Size = 0.25
// window_set_size(GameInfo.Width*Size,GameInfo.Height*Size)
// window_set_position(GameInfo.Width/2-1280/2,GameInfo.Height/2-720/2)//只是单纯的让游戏画面在中间而已

// 	var Size = 0.25
// window_set_size(GameInfo.Width*Size,GameInfo.Height*Size)
// window_set_position(GameInfo.Width/2-1280/2,GameInfo.Height/2-720/2)//只是单纯的让游戏画面在中间而已

 window_set_position(GameInfo.Width/2,GameInfo.Height/2)//只是单纯的让游戏画面在中间而已
