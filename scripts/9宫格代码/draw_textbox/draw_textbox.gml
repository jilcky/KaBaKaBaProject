/// @description  draw_textbox(string, [x, y]);
...
var _tb = metalPanel_blueCorner; //Textbox sprite
...
if (_speaker != undefined){
    ...
    tYMarg = string_height(string_hash_to_newline(spkName)) + spkMarg*2;
    tX += tXMarg;
    tY += tYMarg;
...
//Text height
var tHeight = max(surfH, string_height_ext(string_hash_to_newline(string_copy(_string, 1, _char)), -1, edgeW - tXMarg) * 1.2);
